...
public class Processor {
    ...
    final private StringBuffer playerNumber = new StringBuffer(DEFINE.INPUT_NUMBER_DIGIT);
    final private StringBuffer managerNumber = new StringBuffer(DEFINE.INPUT_NUMBER_DIGIT);
    ...
    public void process() {
        ...
        for (int i = 0; i < DEFINE.INPUT_NUMBER_DIGIT ; i++) {
            for (int j = 0; j < DEFINE.INPUT_NUMBER_DIGIT ; j++) {
